...
CREATE TABLE vincent_letters(
    ...
    original TEXT,
    -- 原文，法语、荷兰语为主
    translation_en_vgm TEXT,
    -- 英文译文，Van Gogh Museum版本 2009年出版，此外还有早期的Jo-Bonger版本。
    translation_zh_vgm TEXT,
    -- 基于vgm英文译文的中文译本(由上海美术出版社于2015年出版)
    translation_zh_ai TEXT,
    -- 自己用ai翻译,防止上海美术出版社版权问题。
    -- 附加信息，json结构
    notes TEXT,
    -- 注释， json文本，以序号排列
    facsimile TEXT,
...
CREATE TABLE IF NOT EXISTS "artwork_color_scores" (
    ...
    "score_01" REAL DEFAULT 0.0,
    -- 湖水青蓝
    "score_02" REAL DEFAULT 0.0,
    -- 深空靛蓝
    "score_03" REAL DEFAULT 0.0,
    -- 柔和米灰
    "score_04" REAL DEFAULT 0.0,
    -- 清新薄荷绿
    "score_05" REAL DEFAULT 0.0,
    -- 深沉橄榄
    "score_06" REAL DEFAULT 0.0,
    -- 古典棕绿
    "score_07" REAL DEFAULT 0.0,
    -- 浓郁焦棕
    "score_08" REAL DEFAULT 0.0,
    -- 暖调赤土
    "score_09" REAL DEFAULT 0.0,
    -- 亮金赭石
    "score_10" REAL DEFAULT 0.0,
    -- 向日葵亮黄
...
CREATE TABLE "user" (
    ...
    "registered_at" DATETIME NOT NULL DEFAULT (strftime('%Y-%m-%d %H:%M:%f', 'now')),
    "last_login_at" DATETIME,
    "is_active" INTEGER NOT NULL DEFAULT 0,
    "update_at" DATETIME NOT NULL DEFAULT (strftime('%Y-%m-%d %H:%M:%f', 'now')),
    "email_verify_code" TEXT,
    "email_verify_expire_at" DATETIME,
