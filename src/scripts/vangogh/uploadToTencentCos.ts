...
import { batchUploadFiles, CosFileTask, uploadFile } from "../tencentCloud/upload.js";
import * as fs from 'fs';
import * as path from 'path';
import { buildVgKey, extractVgCodeFromFileName } from "./VangoghUtils.js";
import { ArtworkVincentDao } from "../../db/ArtworkVincentDAO.js";
import { dbArtwork } from "../../db/db.js";
async function main() {
