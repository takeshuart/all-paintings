...
import { ArticArtWork, ArticArtWorkInfo } from './artic-model.js';
import { ArtWork } from './artwork.js';
import { saveArtWorksToJSON } from './wikipage.js';
import { json } from 'stream/consumers';
import { fineArtsIds } from './artic-config.js';
import { insert } from '../../db/sqllite-utils.js'
...
const topFile = path.join(DATA_FILES_ROOT, 'artic-top300-ids.txt');
const top300File = path.join(DATA_FILES_ROOT, 'artic-top300-details.txt');
const articAllIdOfPaintingsFile = path.join(DATA_FILES_ROOT, 'artic-all-ids-of-paintings.txt');
