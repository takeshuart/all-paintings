...
const catalogFile = path.join(DATA_FILES_ROOT, './van gogh/musee-orsay-catalog-VincentVanGogh.json');
const detailsFile = path.join(DATA_FILES_ROOT, './van gogh/musee-orsay-details-VincentVanGogh.json');
