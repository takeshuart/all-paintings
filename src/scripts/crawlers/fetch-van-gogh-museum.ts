...
const catalogFile = path.join(DATA_FILES_ROOT, './van gogh/vangoghmuseum-catalog-VincentVanGogh.json');
const detailsFile = path.join(DATA_FILES_ROOT, './van gogh/vangoghmuseum-details-VincentVanGogh.json');
const lettersPhotoFile = path.join(DATA_FILES_ROOT, './van gogh/vangoghmuseum-letters-VincentVanGogh.json');
